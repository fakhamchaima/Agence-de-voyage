    ...
    <link rel="stylesheet" href="offreStyle.css">
        ...
        <style>
            #imagePrincipalehaj
            {
                ...
                width:100% ;
                animation: imagePrincipalehaj 15s  infinite ;
            }

            @keyframes imagePrincipalehaj
            {
                
                0%{background: url(images/mecca1.jpg)no-repeat  ;
                background-size: 100% 100%;}
                40%{background: url(images/medina.jpg ) no-repeat ;
                background-size: 100% 100%;}
                60%{ background: url(images/mecca2.jfif) no-repeat ;
                background-size: 100% 100%;}
                80%{background: url(images/mecca.jpg) no-repeat ;
                background-size: 100% 100%;}
                100%{background: url(images/mecca3.jfif ) no-repeat ;
                background-size: 100% 100%;}
            }
        ...
        <body>
            ...
            <div id="imagePrincipalehaj">
                <h1>الحج والعمرة</h1>
                
                <h3>زيارة بيت الله خير من ألف سفر </h3>
